...
// Source: controllers/nodeupgrade_controller.go
//
// Generated by this command:
//
//	mockgen --build_flags=--mod=mod -destination=controllers/mocks/nodeupgrade_controller.go -package=mocks -source controllers/nodeupgrade_controller.go RemoteClientRegistry
//
...
func (mr *MockRemoteClientRegistryMockRecorder) GetClient(ctx, cluster any) *gomock.Call {
