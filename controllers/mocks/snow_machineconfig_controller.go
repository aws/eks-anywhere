...
//
//	mockgen --build_flags=--mod=mod -destination=controllers/mocks/snow_machineconfig_controller.go -package=mocks -source controllers/snow_machineconfig_controller.go
//
...
func (mr *MockValidatorMockRecorder) ValidateEC2ImageExistsOnDevice(ctx, m any) *gomock.Call {
...
func (mr *MockValidatorMockRecorder) ValidateEC2SshKeyNameExists(ctx, m any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
