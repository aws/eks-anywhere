...
func (m *MockResourceFetcher) MachineDeployments(arg0 context.Context, arg1 *v1alpha1.Cluster) (map[string]*v1beta11.MachineDeployment, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "MachineDeployments", arg0, arg1)
	ret0, _ := ret[0].(map[string]*v1beta11.MachineDeployment)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockResourceFetcher) VSphereWorkerMachineTemplates(arg0 context.Context, arg1 *v1alpha1.Cluster) ([]v1beta10.VSphereMachineTemplate, error) {
	m.ctrl.T.Helper()
