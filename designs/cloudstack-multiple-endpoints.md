...
Our customer needs to support running Cloudstack EKS-A clusters across multiple Cloudstack API endpoints. In CAPC, we are considering
addressing the problem by relying on Failure Domains and distributing a cluster across the given ones. In order to support this functionality in EKS-A,
