...
require (
	...
	github.com/aws/etcdadm-controller v1.0.2
...
require (
	...
	github.com/aws/etcdadm-bootstrap-provider v1.0.4 // indirect
...
replace (
	...
	sigs.k8s.io/cluster-api => github.com/abhay-krishna/cluster-api v1.2.0-custom
