...
require (
	...
	github.com/aws/etcdadm-controller v1.0.18
	...
	sigs.k8s.io/cluster-api-provider-vsphere v1.8.5
...
replace (
	...
	// Temp replace till CAPC upstream PR #342 gets merged.
	sigs.k8s.io/cluster-api-provider-cloudstack => github.com/pokearu/cluster-api-provider-cloudstack v0.4.10-dev
