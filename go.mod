...
require (
	...
	github.com/aws/eks-anywhere-packages v0.4.6
	...
	github.com/aws/etcdadm-bootstrap-provider v1.0.15
	github.com/aws/etcdadm-controller v1.0.24
	...
	sigs.k8s.io/cluster-api-provider-vsphere v1.9.6
