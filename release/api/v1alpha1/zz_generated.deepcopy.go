...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HookOS) DeepCopyInto(out *HookOS) {
	*out = *in
	in.Initramfs.DeepCopyInto(&out.Initramfs)
	in.Vmlinuz.DeepCopyInto(&out.Vmlinuz)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HookOS.
func (in *HookOS) DeepCopy() *HookOS {
	if in == nil {
		return nil
	}
	out := new(HookOS)
