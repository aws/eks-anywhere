...
func (in *BottlerocketBootstrapContainersBundle) DeepCopyInto(out *BottlerocketBootstrapContainersBundle) {
	*out = *in
	in.MultiNetworkBootstrap.DeepCopyInto(&out.MultiNetworkBootstrap)
}
...
func (in *BottlerocketBootstrapContainersBundle) DeepCopy() *BottlerocketBootstrapContainersBundle {
	...
	out := new(BottlerocketBootstrapContainersBundle)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PackageBundle) DeepCopyInto(out *PackageBundle) {
	*out = *in
	...
	in.HelmChart.DeepCopyInto(&out.HelmChart)
	in.CRDChart.DeepCopyInto(&out.CRDChart)
}
...
func (in *TinkBundle) DeepCopyInto(out *TinkBundle) {
	*out = *in
	if in.TinkRelay != nil {
		in, out := &in.TinkRelay, &out.TinkRelay
		*out = new(Image)
		(*in).DeepCopyInto(*out)
	}
	in.TinkRelayInit.DeepCopyInto(&out.TinkRelayInit)
	if in.TinkController != nil {
		in, out := &in.TinkController, &out.TinkController
		*out = new(Image)
		(*in).DeepCopyInto(*out)
	}
	if in.TinkServer != nil {
		in, out := &in.TinkServer, &out.TinkServer
		*out = new(Image)
		(*in).DeepCopyInto(*out)
	}
	if in.TinkWorker != nil {
		in, out := &in.TinkWorker, &out.TinkWorker
		*out = new(Image)
		(*in).DeepCopyInto(*out)
	}
	if in.Nginx != nil {
...
func (in *TinkerbellStackBundle) DeepCopyInto(out *TinkerbellStackBundle) {
	*out = *in
	...
	if in.Rufio != nil {
		in, out := &in.Rufio, &out.Rufio
		*out = new(Image)
		(*in).DeepCopyInto(*out)
	}
	in.Tink.DeepCopyInto(&out.Tink)
	in.TinkerbellCrds.DeepCopyInto(&out.TinkerbellCrds)
...
func (in *VersionsBundle) DeepCopyInto(out *VersionsBundle) {
	*out = *in
	...
	in.BottleRocketBootstrapContainers.DeepCopyInto(&out.BottleRocketBootstrapContainers)
