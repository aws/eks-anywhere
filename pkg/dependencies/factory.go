...
func (f *Factory) WithProvider(clusterConfigFile string, clusterConfig *v1alpha1.Cluster, skipIpCheck bool, hardwareConfigFile string, skipBmcCheck bool) *Factory {
	...
	f.buildSteps = append(f.buildSteps, func(ctx context.Context) error {
		...
		var err error
		f.dependencies.Provider, err = f.providerFactory.BuildProvider(clusterConfigFile, clusterConfig, skipIpCheck, hardwareConfigFile, skipBmcCheck)
		if err != nil {
			return err
		}
