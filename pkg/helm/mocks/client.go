...
//
//	mockgen --build_flags=--mod=mod -destination=pkg/helm/mocks/client.go -package=mocks -source pkg/helm/client.go
//
...
func (mr *MockClientMockRecorder) Delete(ctx, kubeconfigFilePath, installName, namespace any) *gomock.Call {
...
func (mr *MockClientMockRecorder) InstallChart(ctx, chart, ociURI, version, kubeconfigFilePath, namespace, valueFilePath, skipCRDs, values any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockClientMockRecorder) ListCharts(ctx, kubeconfigFilePath, filter, namespace any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockClientMockRecorder) PullChart(ctx, ociURI, version any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockClientMockRecorder) PushChart(ctx, chart, registry any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockClientMockRecorder) RegistryLogin(ctx, registry, username, password any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockClientMockRecorder) SaveChart(ctx, ociURI, version, folder any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockClient) Template(ctx context.Context, ociURI, version, namespace string, values any, kubeVersion string) ([]byte, error) {
	m.ctrl.T.Helper()
...
func (mr *MockClientMockRecorder) Template(ctx, ociURI, version, namespace, values, kubeVersion any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockClientMockRecorder) Uninstall(ctx, chart, kubeconfigFilePath, namespace any, opts ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockClientMockRecorder) UpgradeInstallChartWithValuesFile(ctx, chart, ociURI, version, kubeconfigFilePath, namespace, valuesFilePath any, opts ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
