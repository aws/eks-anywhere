...
//
//	mockgen --build_flags=--mod=mod -destination=pkg/helm/mocks/factory.go -package=mocks -source pkg/helm/factory.go
//
...
func (mr *MockClientBuilderMockRecorder) BuildHelm(arg0 ...any) *gomock.Call {
