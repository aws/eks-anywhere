...
func (fc *fluxForCluster) writeFluxSystemFiles() (err error) {
	...
	logger.V(3).Info("Generating flux-system components file...")
	if err = fc.generateFluxComponentsFile(t); err != nil {
		return err
	}
...
func (fc *fluxForCluster) generateFluxComponentsFile(t *templater.Templater) error {
	bundle := fc.clusterSpec.VersionsBundle

	componentsManifest, err := fc.clusterSpec.LoadManifest(bundle.Flux.Components)
	if err != nil {
