...
//
//	mockgen --build_flags=--mod=mod -destination=pkg/crypto/mocks/validator.go -package=mocks -source pkg/crypto/validator.go TlsValidator
//
...
func (mr *MockTlsValidatorMockRecorder) IsSignedByUnknownAuthority(host, port any) *gomock.Call {
...
func (mr *MockTlsValidatorMockRecorder) ValidateCert(host, port, caCertContent any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
