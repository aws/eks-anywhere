...
type ClusterManager interface {
	...
	Upgrade(ctx context.Context, cluster *types.Cluster, currentVersionsBundle *releasev1alpha1.VersionsBundle, newVersionsBundle *releasev1alpha1.VersionsBundle, newSpec *cluster.Spec) (*types.ChangeDiff, error)
...
type GitOpsManager interface {
	...
	Upgrade(ctx context.Context, cluster *types.Cluster, currentVersionsBundle, newVersionsBundle *releasev1alpha1.VersionsBundle, oldSpec, newSpec *cluster.Spec) (*types.ChangeDiff, error)
}
...
type CAPIManager interface {
	Upgrade(ctx context.Context, managementCluster *types.Cluster, provider providers.Provider, currentVersionsBundle, newVersionsBundle *releasev1alpha1.VersionsBundle, newSpec *cluster.Spec) (*types.ChangeDiff, error)
...
type EksdUpgrader interface {
	Upgrade(ctx context.Context, cluster *types.Cluster, currentVersionsBundle, newVersionsBundle *releasev1alpha1.VersionsBundle, newSpec *cluster.Spec) (*types.ChangeDiff, error)
}
