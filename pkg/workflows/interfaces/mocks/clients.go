...
// Source: github.com/aws/eks-anywhere/pkg/workflows/interfaces (interfaces: Bootstrapper,ClusterManager,GitOpsManager,Validator,CAPIManager,EksdInstaller,EksdUpgrader,PackageInstaller,ManagementUpgrader)
...
// UpgradeEKSAResources mocks base method.
func (m *MockClusterManager) UpgradeEKSAResources(arg0 context.Context, arg1 *types.Cluster, arg2 *cluster.Spec, arg3 providers.DatacenterConfig, arg4 []providers.MachineConfig) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpgradeEKSAResources", arg0, arg1, arg2, arg3, arg4)
	ret0, _ := ret[0].(error)
	return ret0
}

// UpgradeEKSAResources indicates an expected call of UpgradeEKSAResources.
func (mr *MockClusterManagerMockRecorder) UpgradeEKSAResources(arg0, arg1, arg2, arg3, arg4 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpgradeEKSAResources", reflect.TypeOf((*MockClusterManager)(nil).UpgradeEKSAResources), arg0, arg1, arg2, arg3, arg4)
}
...
// MockManagementUpgrader is a mock of ManagementUpgrader interface.
type MockManagementUpgrader struct {
	ctrl     *gomock.Controller
	recorder *MockManagementUpgraderMockRecorder
}

// MockManagementUpgraderMockRecorder is the mock recorder for MockManagementUpgrader.
type MockManagementUpgraderMockRecorder struct {
	mock *MockManagementUpgrader
}

// NewMockManagementUpgrader creates a new mock instance.
func NewMockManagementUpgrader(ctrl *gomock.Controller) *MockManagementUpgrader {
	mock := &MockManagementUpgrader{ctrl: ctrl}
	mock.recorder = &MockManagementUpgraderMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockManagementUpgrader) EXPECT() *MockManagementUpgraderMockRecorder {
	return m.recorder
}

// UpgradeManagementCluster mocks base method.
func (m *MockManagementUpgrader) UpgradeManagementCluster(arg0 context.Context, arg1 *types.Cluster) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpgradeManagementCluster", arg0, arg1)
	ret0, _ := ret[0].(error)
	return ret0
}

// UpgradeManagementCluster indicates an expected call of UpgradeManagementCluster.
func (mr *MockManagementUpgraderMockRecorder) UpgradeManagementCluster(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpgradeManagementCluster", reflect.TypeOf((*MockManagementUpgrader)(nil).UpgradeManagementCluster), arg0, arg1)
}
