...
func (m *MockAddonManager) UpdateLegacyFileStructure(arg0 context.Context, arg1 *cluster.Spec) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateLegacyFileStructure", arg0, arg1)
	ret0, _ := ret[0].(error)
	return ret0
}

// UpdateLegacyFileStructure indicates an expected call of UpdateLegacyFileStructure.
func (mr *MockAddonManagerMockRecorder) UpdateLegacyFileStructure(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateLegacyFileStructure", reflect.TypeOf((*MockAddonManager)(nil).UpdateLegacyFileStructure), arg0, arg1)
}
