...
// Source: github.com/aws/eks-anywhere/pkg/workflows/interfaces (interfaces: Bootstrapper,ClusterManager,AddonManager,Validator,CAPIUpgrader)
...
// SaveLogsBootstrapCluster mocks base method.
func (m *MockClusterManager) SaveLogsBootstrapCluster(arg0 context.Context, arg1 *types.Cluster) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SaveLogsBootstrapCluster", arg0, arg1)
	ret0, _ := ret[0].(error)
	return ret0
}

// SaveLogsBootstrapCluster indicates an expected call of SaveLogsBootstrapCluster.
func (mr *MockClusterManagerMockRecorder) SaveLogsBootstrapCluster(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SaveLogsBootstrapCluster", reflect.TypeOf((*MockClusterManager)(nil).SaveLogsBootstrapCluster), arg0, arg1)
}
...
type MockCAPIUpgrader struct {
	ctrl     *gomock.Controller
	recorder *MockCAPIUpgraderMockRecorder
}

// MockCAPIUpgraderMockRecorder is the mock recorder for MockCAPIUpgrader.
type MockCAPIUpgraderMockRecorder struct {
	mock *MockCAPIUpgrader
}

// NewMockCAPIUpgrader creates a new mock instance.
func NewMockCAPIUpgrader(ctrl *gomock.Controller) *MockCAPIUpgrader {
	mock := &MockCAPIUpgrader{ctrl: ctrl}
	mock.recorder = &MockCAPIUpgraderMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockCAPIUpgrader) EXPECT() *MockCAPIUpgraderMockRecorder {
	return m.recorder
}
...
// Upgrade indicates an expected call of Upgrade.
func (mr *MockCAPIUpgraderMockRecorder) Upgrade(arg0, arg1, arg2, arg3, arg4 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Upgrade", reflect.TypeOf((*MockCAPIUpgrader)(nil).Upgrade), arg0, arg1, arg2, arg3, arg4)
}
