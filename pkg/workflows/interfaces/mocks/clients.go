...
// Source: github.com/aws/eks-anywhere/pkg/workflows/interfaces (interfaces: Bootstrapper,ClusterManager,GitOpsManager,Validator,CAPIManager,EksdInstaller,EksdUpgrader,PackageInstaller,ClusterUpgrader,ClusterCreator,Cluster)
...
// WaitUntilControlPlaneAvailable mocks base method.
func (m *MockCluster) WaitUntilControlPlaneAvailable(arg0 context.Context, arg1 *types.Cluster) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "WaitUntilControlPlaneAvailable", arg0, arg1)
	ret0, _ := ret[0].(error)
	return ret0
}

// WaitUntilControlPlaneAvailable indicates an expected call of WaitUntilControlPlaneAvailable.
func (mr *MockClusterMockRecorder) WaitUntilControlPlaneAvailable(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "WaitUntilControlPlaneAvailable", reflect.TypeOf((*MockCluster)(nil).WaitUntilControlPlaneAvailable), arg0, arg1)
}

// WriteKubeconfig mocks base method.
func (m *MockCluster) WriteKubeconfig(arg0 context.Context, arg1 io.Writer, arg2 *types.Cluster) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "WriteKubeconfig", arg0, arg1, arg2)
	ret0, _ := ret[0].(error)
	return ret0
}

// WriteKubeconfig indicates an expected call of WriteKubeconfig.
func (mr *MockClusterMockRecorder) WriteKubeconfig(arg0, arg1, arg2 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "WriteKubeconfig", reflect.TypeOf((*MockCluster)(nil).WriteKubeconfig), arg0, arg1, arg2)
}
