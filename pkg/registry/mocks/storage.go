...
//
//	mockgen --build_flags=--mod=mod -destination=pkg/registry/mocks/storage.go -package=mocks -source pkg/registry/storage.go StorageClient
//
...
func (mr *MockStorageClientMockRecorder) CopyGraph(ctx, srcStorage, srcRef, dstStorage, dstRef any) *gomock.Call {
...
func (mr *MockStorageClientMockRecorder) Destination(image any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStorageClientMockRecorder) FetchBlob(ctx, srcStorage, descriptor any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStorageClientMockRecorder) FetchBytes(ctx, srcStorage, artifact any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStorageClientMockRecorder) GetStorage(ctx, image any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStorageClientMockRecorder) Resolve(ctx, srcStorage, versionedImage any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStorageClientMockRecorder) SetProject(project any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStorageClientMockRecorder) Tag(ctx, dstStorage, desc, tag any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
