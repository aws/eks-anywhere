...
//
//	mockgen --build_flags=--mod=mod -destination=pkg/clusterapi/mocks/capiclient.go -package=mocks -source pkg/clusterapi/manager.go CAPIClient,KubectlClient
//
...
func (m *MockCAPIClient) InstallEtcdadmProviders(ctx context.Context, managementComponents *cluster.ManagementComponents, clusterSpec *cluster.Spec, arg3 *types.Cluster, provider providers.Provider, installProviders []string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "InstallEtcdadmProviders", ctx, managementComponents, clusterSpec, arg3, provider, installProviders)
	ret0, _ := ret[0].(error)
	return ret0
}

// InstallEtcdadmProviders indicates an expected call of InstallEtcdadmProviders.
func (mr *MockCAPIClientMockRecorder) InstallEtcdadmProviders(ctx, managementComponents, clusterSpec, arg3, provider, installProviders any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "InstallEtcdadmProviders", reflect.TypeOf((*MockCAPIClient)(nil).InstallEtcdadmProviders), ctx, managementComponents, clusterSpec, arg3, provider, installProviders)
}
...
func (mr *MockCAPIClientMockRecorder) Upgrade(ctx, managementCluster, provider, managementComponents, newSpec, changeDiff any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockKubectlClientMockRecorder) CheckProviderExists(ctx, kubeconfigFile, name, namespace any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
