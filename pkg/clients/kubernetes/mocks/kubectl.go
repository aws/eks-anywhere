...
//
//	mockgen --build_flags=--mod=mod -destination=pkg/clients/kubernetes/mocks/kubectl.go -package=mocks -source pkg/clients/kubernetes/kubectl.go
//
...
func (m *MockKubectl) Apply(ctx context.Context, kubeconfig string, obj runtime.Object, opts ...kubernetes.KubectlApplyOption) error {
	m.ctrl.T.Helper()
	varargs := []any{ctx, kubeconfig, obj}
	for _, a := range opts {
...
func (mr *MockKubectlMockRecorder) Apply(ctx, kubeconfig, obj any, opts ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, kubeconfig, obj}, opts...)
...
func (mr *MockKubectlMockRecorder) Create(ctx, kubeconfig, obj any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockKubectl) Delete(ctx context.Context, resourceType, kubeconfig string, opts ...kubernetes.KubectlDeleteOption) error {
	m.ctrl.T.Helper()
	varargs := []any{ctx, resourceType, kubeconfig}
	for _, a := range opts {
		varargs = append(varargs, a)
	}
...
func (mr *MockKubectlMockRecorder) Delete(ctx, resourceType, kubeconfig any, opts ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, resourceType, kubeconfig}, opts...)
...
func (m *MockKubectl) Get(ctx context.Context, resourceType, kubeconfig string, obj runtime.Object, opts ...kubernetes.KubectlGetOption) error {
	m.ctrl.T.Helper()
	varargs := []any{ctx, resourceType, kubeconfig, obj}
	for _, a := range opts {
		varargs = append(varargs, a)
	}
...
func (mr *MockKubectlMockRecorder) Get(ctx, resourceType, kubeconfig, obj any, opts ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, resourceType, kubeconfig, obj}, opts...)
...
func (mr *MockKubectlMockRecorder) Replace(ctx, kubeconfig, obj any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockKubectlGetOptionMockRecorder) ApplyToGet(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockKubectlApplyOptionMockRecorder) ApplyToApply(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockKubectlDeleteOptionMockRecorder) ApplyToDelete(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
