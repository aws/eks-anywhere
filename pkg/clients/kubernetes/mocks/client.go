...
func (m *MockClient) List(ctx context.Context, list kubernetes.ObjectList, opt ...kubernetes.ListOption) error {
	m.ctrl.T.Helper()
...
func (mr *MockClientMockRecorder) List(ctx, list interface{}, opt ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{ctx, list}, opt...)
...
// List mocks base method.
func (m *MockReader) List(ctx context.Context, list kubernetes.ObjectList, opt ...kubernetes.ListOption) error {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, list}
	for _, a := range opt {
		varargs = append(varargs, a)
...
// List indicates an expected call of List.
func (mr *MockReaderMockRecorder) List(ctx, list interface{}, opt ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{ctx, list}, opt...)
