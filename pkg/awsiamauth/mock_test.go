...
//
//	mockgen --build_flags=--mod=mod -destination=pkg/awsiamauth/mock_test.go -package=awsiamauth_test -source pkg/awsiamauth/installer.go
//
...
func (mr *MockKubernetesClientMockRecorder) Apply(ctx, cluster, data any) *gomock.Call {
...
func (mr *MockKubernetesClientMockRecorder) GetAPIServerURL(ctx, cluster any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockKubernetesClientMockRecorder) GetAWSIAMKubeconfigSecretValue(ctx, cluster, clusterName any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockKubernetesClientMockRecorder) GetClusterCACert(ctx, cluster, clusterName any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
