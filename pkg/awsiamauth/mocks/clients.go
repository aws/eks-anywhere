...
//
//	mockgen --build_flags=--mod=mod -destination=pkg/awsiamauth/mocks/clients.go -package=mocks -source pkg/awsiamauth/client.go
//
...
func (mr *MockClientMockRecorder) ApplyKubeSpecFromBytes(ctx, cluster, data any) *gomock.Call {
...
func (mr *MockClientMockRecorder) GetApiServerUrl(ctx, cluster any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockClientMockRecorder) GetObject(ctx, resourceType, name, namespace, kubeconfig, obj any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
