...
//
//	mockgen --build_flags=--mod=mod -destination=pkg/diagnostics/interfaces/mocks/diagnostics.go -package=mocks -source pkg/diagnostics/interfaces.go DiagnosticBundle,AnalyzerFactory,CollectorFactory,BundleClient
//
...
func (mr *MockBundleClientMockRecorder) Analyze(ctx, bundleSpecPath, archivePath any) *gomock.Call {
...
func (mr *MockBundleClientMockRecorder) Collect(ctx, bundlePath, sinceTime, kubeconfig any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDiagnosticBundleFactoryMockRecorder) DiagnosticBundle(spec, provider, kubeconfig, bundlePath, auditLogs any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDiagnosticBundleFactoryMockRecorder) DiagnosticBundleCustom(kubeconfig, bundlePath any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDiagnosticBundleFactoryMockRecorder) DiagnosticBundleManagementCluster(spec, kubeconfig any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDiagnosticBundleFactoryMockRecorder) DiagnosticBundleWorkloadCluster(spec, provider, kubeconfig, auditLogs any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDiagnosticBundleMockRecorder) CollectAndAnalyze(ctx, sinceTimeValue any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDiagnosticBundleMockRecorder) WithDatacenterConfig(config, spec any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDiagnosticBundleMockRecorder) WithExternalEtcd(config any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDiagnosticBundleMockRecorder) WithFileCollectors(paths any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDiagnosticBundleMockRecorder) WithGitOpsConfig(config any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDiagnosticBundleMockRecorder) WithMachineConfigs(configs any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDiagnosticBundleMockRecorder) WithOidcConfig(config any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAnalyzerFactoryMockRecorder) DataCenterConfigAnalyzers(datacenter any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAnalyzerFactoryMockRecorder) EksaLogTextAnalyzers(collectors any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCollectorFactoryMockRecorder) DataCenterConfigCollectors(datacenter, spec any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCollectorFactoryMockRecorder) EksaHostCollectors(configs any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCollectorFactoryMockRecorder) FileCollectors(paths any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCollectorFactoryMockRecorder) HostCollectors(datacenter any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
