...
//
//	mockgen --build_flags=--mod=mod -destination=pkg/kubeconfig/mocks/writer.go -package=mocks -source pkg/kubeconfig/kubeconfig.go Writer
//
...
func (mr *MockWriterMockRecorder) WriteKubeconfig(ctx, clusterName, kubeconfig, w any) *gomock.Call {
...
func (mr *MockWriterMockRecorder) WriteKubeconfigContent(ctx, clusterName, content, w any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
