...
//
//	mockgen --build_flags=--mod=mod -destination=pkg/validations/mocks/kubectl.go -package=mocks -source pkg/validations/kubectl.go KubectlClient
//
...
func (mr *MockKubectlClientMockRecorder) GetBundles(ctx, kubeconfigFile, name, namespace any) *gomock.Call {
...
func (mr *MockKubectlClientMockRecorder) GetClusters(ctx, cluster any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockKubectlClientMockRecorder) GetEksaAWSIamConfig(ctx, awsIamConfigName, kubeconfigFile, namespace any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockKubectlClientMockRecorder) GetEksaCluster(ctx, cluster, clusterName any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockKubectlClientMockRecorder) GetEksaFluxConfig(ctx, fluxConfigName, kubeconfigFile, namespace any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockKubectlClientMockRecorder) GetEksaGitOpsConfig(ctx, gitOpsConfigName, kubeconfigFile, namespace any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockKubectlClientMockRecorder) GetEksaOIDCConfig(ctx, oidcConfigName, kubeconfigFile, namespace any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockKubectlClientMockRecorder) GetEksaTinkerbellDatacenterConfig(ctx, tinkerbellDatacenterConfigName, kubeconfigFile, namespace any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockKubectlClientMockRecorder) GetEksaTinkerbellMachineConfig(ctx, tinkerbellMachineConfigName, kubeconfigFile, namespace any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockKubectlClientMockRecorder) GetEksaVSphereDatacenterConfig(ctx, vsphereDatacenterConfigName, kubeconfigFile, namespace any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockKubectlClientMockRecorder) GetObject(ctx, resourceType, name, namespace, kubeconfig, obj any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockKubectlClient) List(ctx context.Context, kubeconfig string, list kubernetes.ObjectList, opts ...kubernetes.ListOption) error {
	m.ctrl.T.Helper()
	varargs := []any{ctx, kubeconfig, list}
	for _, a := range opts {
...
func (mr *MockKubectlClientMockRecorder) List(ctx, kubeconfig, list any, opts ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, kubeconfig, list}, opts...)
...
func (mr *MockKubectlClientMockRecorder) SearchIdentityProviderConfig(ctx, ipName, kind, kubeconfigFile, namespace any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockKubectlClientMockRecorder) ValidateClustersCRD(ctx, cluster any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockKubectlClientMockRecorder) ValidateControlPlaneNodes(ctx, cluster, clusterName any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockKubectlClientMockRecorder) ValidateEKSAClustersCRD(ctx, cluster any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockKubectlClientMockRecorder) ValidateNodes(ctx, kubeconfig any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockKubectlClientMockRecorder) ValidateWorkerNodes(ctx, clusterName, kubeconfig any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockKubectlClientMockRecorder) Version(ctx, cluster any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
