	...
	upgradeValidations := []validations.Validation{
		...
		func() *validations.ValidationResult {
			return &validations.ValidationResult{
				...
				Remediation: "ensure that the cluster worker node group kubernetes version is incremented by one minor version exactly (e.g. 1.18 -> 1.19) and top level kubernetes version does not exceed worker node group version by two minor versions",
