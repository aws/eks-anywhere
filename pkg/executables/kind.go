...
func (k *Kind) setupExecConfig(clusterSpec *cluster.Spec) error {
	...
	if clusterSpec.Cluster.Spec.RegistryMirrorConfiguration != nil {
		if err := k.setupRegistryConfiguration(clusterSpec, registryMirror); err != nil {
			return err
		}
	}
...
// setupRegistryConfiguration handles the complete setup of registry mirror configuration.
func (k *Kind) setupRegistryConfiguration(clusterSpec *cluster.Spec, registryMirror *registrymirror.RegistryMirror) error {
