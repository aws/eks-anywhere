...
//
//	mockgen --build_flags=--mod=mod -destination=pkg/aws/mocks/snowballdevice.go -package=mocks -source pkg/aws/snowballdevice.go
//
...
func (mr *MockSnowballDeviceClientMockRecorder) DescribeDevice(ctx, params any, optFns ...any) *gomock.Call {
...
func (mr *MockSnowballDeviceClientMockRecorder) DescribeDeviceSoftware(ctx, params any, optFns ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, params}, optFns...)
