...
//
//	mockgen --build_flags=--mod=mod -destination=pkg/aws/mocks/imds.go -package=mocks -source pkg/aws/imds.go
//
...
func (mr *MockIMDSClientMockRecorder) GetMetadata(ctx, params any, optFns ...any) *gomock.Call {
