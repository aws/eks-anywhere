...
//
//	mockgen --build_flags=--mod=mod -destination=pkg/aws/mocks/ec2.go -package=mocks -source pkg/aws/ec2.go
//
...
func (mr *MockEC2ClientMockRecorder) DescribeImages(ctx, params any, optFns ...any) *gomock.Call {
...
func (mr *MockEC2ClientMockRecorder) DescribeInstanceTypes(ctx, params any, optFns ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, params}, optFns...)
...
func (mr *MockEC2ClientMockRecorder) DescribeKeyPairs(ctx, params any, optFns ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, params}, optFns...)
...
func (mr *MockEC2ClientMockRecorder) ImportKeyPair(ctx, params any, optFns ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, params}, optFns...)
