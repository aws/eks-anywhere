...
//
//	mockgen --build_flags=--mod=mod -destination=pkg/curatedpackages/mocks/installer.go -package=mocks -source pkg/curatedpackages/packagecontrollerclient.go ChartManager ClientBuilder
//
...
func (mr *MockClientBuilderMockRecorder) GetClient(arg0, arg1 any) *gomock.Call {
...
func (mr *MockChartInstallerMockRecorder) InstallChart(ctx, chart, ociURI, version, kubeconfigFilePath, namespace, valueFilePath, skipCRDs, values any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockChartUninstallerMockRecorder) Delete(ctx, kubeconfigFilePath, installName, namespace any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// Delete indicates an expected call of Delete.
func (mr *MockChartManagerMockRecorder) Delete(ctx, kubeconfigFilePath, installName, namespace any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// InstallChart indicates an expected call of InstallChart.
func (mr *MockChartManagerMockRecorder) InstallChart(ctx, chart, ociURI, version, kubeconfigFilePath, namespace, valueFilePath, skipCRDs, values any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockChartManagerMockRecorder) RegistryLogin(ctx, registry, username, password any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// Delete indicates an expected call of Delete.
func (mr *MockKubeDeleterMockRecorder) Delete(arg0, arg1 any, arg2 ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
