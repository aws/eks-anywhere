...
//
//	mockgen --build_flags=--mod=mod -destination=pkg/curatedpackages/mocks/kubectlrunner.go -package=mocks -source pkg/curatedpackages/kubectlrunner.go KubectlRunner
//
...
func (mr *MockKubectlRunnerMockRecorder) ExecuteCommand(ctx any, opts ...any) *gomock.Call {
...
func (mr *MockKubectlRunnerMockRecorder) ExecuteFromYaml(ctx, yaml any, opts ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, yaml}, opts...)
...
func (mr *MockKubectlRunnerMockRecorder) GetObject(ctx, resourceType, name, namespece, kubeconfig, obj any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockKubectlRunnerMockRecorder) HasResource(ctx, resourceType, name, kubeconfig, namespace any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
