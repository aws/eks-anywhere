...
//
//	mockgen --build_flags=--mod=mod -destination=pkg/curatedpackages/mocks/bundlemanager.go -package=mocks -source pkg/curatedpackages/bundlemanager.go Manager
//
...
func (mr *MockManagerMockRecorder) LatestBundle(ctx, baseRef, kubeMajor, kubeMinor, clusterName any) *gomock.Call {
