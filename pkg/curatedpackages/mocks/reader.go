...
//
//	mockgen --build_flags=--mod=mod -destination=pkg/curatedpackages/mocks/reader.go -package=mocks -source pkg/curatedpackages/bundle.go Reader BundleRegistry
//
...
func (mr *MockBundleRegistryMockRecorder) GetRegistryBaseRef(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
