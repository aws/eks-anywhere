...
//
//	mockgen --build_flags=--mod=mod -destination=pkg/curatedpackages/mocks/packageinstaller.go -package=mocks -source pkg/curatedpackages/packageinstaller.go PackageController PackageHandler
//
...
func (mr *MockPackageControllerMockRecorder) Enable(ctx any) *gomock.Call {
...
func (mr *MockPackageControllerMockRecorder) IsInstalled(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPackageHandlerMockRecorder) CreatePackages(ctx, fileName, kubeConfig any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
