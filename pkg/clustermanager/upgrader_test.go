...
func TestUpgraderEksdUpgradeSuccess(t *testing.T) {
	...
	tt.newSpec.VersionsBundle.EksD.Components = "testdata/components.yaml"
	tt.newSpec.VersionsBundle.EksD.EksDReleaseUrl = "testdata/components.yaml"
