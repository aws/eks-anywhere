...
// Source: github.com/aws/eks-anywhere/pkg/clustermanager (interfaces: ClusterClient,Networking,AwsIamAuth,EKSAComponents,KubernetesClient,ClientFactory,ClusterApplier)
...
// Upgrade mocks base method.
func (m *MockEKSAComponents) Upgrade(arg0 context.Context, arg1 logr.Logger, arg2 *types.Cluster, arg3, arg4 *v1alpha10.VersionsBundle, arg5 *cluster.Spec) (*types.ChangeDiff, error) {
	m.ctrl.T.Helper()
