...
type EKSAComponents interface {
	...
	Upgrade(ctx context.Context, log logr.Logger, cluster *types.Cluster, currentVersionsBundle *releasev1alpha1.VersionsBundle, newVersionsBundle *releasev1alpha1.VersionsBundle, newSpec *cluster.Spec) (*types.ChangeDiff, error)
}
...
func (c *ClusterManager) Upgrade(ctx context.Context, cluster *types.Cluster, currentVersionsBundle, newVersionsBundle *releasev1alpha1.VersionsBundle, newSpec *cluster.Spec) (*types.ChangeDiff, error) {
	return c.eksaComponents.Upgrade(ctx, logger.Get(), cluster, currentVersionsBundle, newVersionsBundle, newSpec)
}
