...
//
//	mockgen --build_flags=--mod=mod -destination=pkg/networking/reconciler/mocks/reconcilers.go -package=mocks -source pkg/networking/reconciler/reconciler.go
//
...
func (m *MockCiliumReconciler) Reconcile(ctx context.Context, logger logr.Logger, arg2 client.Client, spec *cluster.Spec) (controller.Result, error) {
	m.ctrl.T.Helper()
...
func (mr *MockCiliumReconcilerMockRecorder) Reconcile(ctx, logger, arg2, spec any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Reconcile", reflect.TypeOf((*MockCiliumReconciler)(nil).Reconcile), ctx, logger, arg2, spec)
}
