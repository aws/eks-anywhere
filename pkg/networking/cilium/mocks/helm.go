...
//
//	mockgen --build_flags=--mod=mod -destination=pkg/networking/cilium/mocks/helm.go -package=mocks -source pkg/networking/cilium/templater.go
//
...
func (mr *MockHelmClientFactoryMockRecorder) Get(ctx, clus any) *gomock.Call {
