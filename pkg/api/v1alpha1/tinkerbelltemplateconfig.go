...
func NewDefaultTinkerbellTemplateConfigCreate(name string, versionBundle v1alpha1.VersionsBundle, disk string, tinkerbellIp string) *TinkerbellTemplateConfig {
	...
	defaultActions := GetDefaultActionsFromBundle(versionBundle, disk, tinkerbellIp)
