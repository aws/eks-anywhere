...
func TestClusterValidateUpdateManagementValueImmutable(t *testing.T) {
	...
	g := NewWithT(t)
	_, err := c.ValidateUpdate(cOld)
	g.Expect(err).To(MatchError(ContainSubstring("field is immutable")))
}
...
func TestClusterValidateUpdateControlPlaneConfigurationImmutable(t *testing.T) {
	...
	g := NewWithT(t)
	_, err := c.ValidateUpdate(cOld)
	g.Expect(err).To(MatchError(ContainSubstring("spec.ControlPlaneConfiguration.endpoint: Forbidden: field is immutable")))
}
...
func TestManagementClusterValidateUpdateControlPlaneConfigurationNewMachineGroupRefNilImmutable(t *testing.T) {
	...
	g := NewWithT(t)
	_, err := c.ValidateUpdate(cOld)
	g.Expect(err).To(MatchError(ContainSubstring("ControlPlaneConfiguration.endpoint: Forbidden: field is immutable")))
}
...
func TestWorkloadClusterValidateUpdateControlPlaneConfigurationNewMachineGroupRefNilError(t *testing.T) {
	...
	g := NewWithT(t)
	_, err := c.ValidateUpdate(cOld)
	g.Expect(err).To(MatchError(ContainSubstring("must specify machineGroupRef control plane machines")))
}
...
func TestWorkloadClusterValidateUpdateWorkerNodeConfigurationNewMachineGroupRefNilError(t *testing.T) {
	...
	g := NewWithT(t)
	_, err := c.ValidateUpdate(cOld)
	g.Expect(err).To(MatchError(ContainSubstring("must specify machineGroupRef for worker nodes")))
}
...
func TestWorkloadClusterValidateUpdateExternalEtcdConfigurationNewMachineGroupRefNilError(t *testing.T) {
	...
	g := NewWithT(t)
	_, err := c.ValidateUpdate(cOld)
	g.Expect(err).To(MatchError(ContainSubstring("must specify machineGroupRef for etcd machines")))
}
...
func TestClusterValidateUpdateDatacenterRefImmutable(t *testing.T) {
	...
	g := NewWithT(t)
	_, err := c.ValidateUpdate(cOld)
	g.Expect(err).To(MatchError(ContainSubstring("spec.datacenterRef: Forbidden: field is immutable")))
}
...
func TestClusterValidateUpdateExternalEtcdConfiguration(t *testing.T) {
	...
	for name, tt := range cases {
		t.Run(name, func(t *testing.T) {
			g := NewWithT(t)
			_, err := tt.cNew.ValidateUpdate(tt.cOld)
...
func TestClusterValidateUpdateClusterNetworkPodsImmutable(t *testing.T) {
	...
	g := NewWithT(t)
	_, err := c.ValidateUpdate(cOld)
	g.Expect(err).To(MatchError(ContainSubstring("spec.clusterNetwork.pods: Forbidden: field is immutable")))
}
...
func TestClusterValidateUpdateClusterNetworkServicesImmutable(t *testing.T) {
	...
	g := NewWithT(t)
	_, err := c.ValidateUpdate(cOld)
	g.Expect(err).To(MatchError(ContainSubstring("spec.clusterNetwork.services: Forbidden: field is immutable")))
}
...
func TestClusterValidateUpdateClusterNetworkDNSImmutable(t *testing.T) {
	...
	g := NewWithT(t)
	_, err := c.ValidateUpdate(cOld)
	g.Expect(err).To(MatchError(ContainSubstring("spec.clusterNetwork.dns: Forbidden: field is immutable")))
}
...
func TestClusterValidateUpdateClusterNetworkNodesImmutable(t *testing.T) {
	...
	g := NewWithT(t)
	_, err := c.ValidateUpdate(cOld)
	g.Expect(err).To(MatchError(ContainSubstring("spec.clusterNetwork.nodes: Forbidden: field is immutable")))
}
...
func TestClusterValidateUpdateProxyConfigurationImmutable(t *testing.T) {
	...
	g := NewWithT(t)
	_, err := c.ValidateUpdate(cOld)
	g.Expect(err).To(MatchError(ContainSubstring("spec.ProxyConfiguration: Forbidden: field is immutable")))
}
...
func TestClusterValidateUpdateGitOpsRefImmutable(t *testing.T) {
	...
	g := NewWithT(t)
	_, err := c.ValidateUpdate(cOld)
	g.Expect(err).To(MatchError(ContainSubstring("spec.GitOpsRef: Forbidden: field is immutable")))
}
...
func TestClusterValidateUpdateAWSIamNameImmutableUpdateName(t *testing.T) {
	...
	g := NewWithT(t)
	_, err := c.ValidateUpdate(cOld)
	g.Expect(err).To(MatchError(ContainSubstring("spec.identityProviderRefs.AWSIamConfig: Forbidden: field is immutable")))
}
...
func TestClusterValidateUpdateUnsetBundlesRefImmutable(t *testing.T) {
	...
	g := NewWithT(t)
	_, err := c.ValidateUpdate(cOld)
	g.Expect(err).To(MatchError(ContainSubstring("spec.BundlesRef: Invalid value: \"null\": field cannot be removed after setting")))
}
...
func TestClusterValidateUpdateInvalidType(t *testing.T) {
	...
	g := NewWithT(t)
	_, err := c.ValidateUpdate(cOld)
	g.Expect(err).To(MatchError(ContainSubstring("expected a Cluster but got a *v1alpha1.VSphereDatacenterConfig")))
}
...
func TestClusterCreateEtcdEncryption(t *testing.T) {
	...
	g := NewWithT(t)
	_, err := cluster.ValidateCreate()
	g.Expect(err).To(MatchError(ContainSubstring("etcdEncryption is not supported during cluster creation")))
}
...
func TestClusterUpdateEtcdEncryptionUnsupported(t *testing.T) {
	...
	g := NewWithT(t)
	_, err := cluster.ValidateUpdate(cluster)
	g.Expect(err).To(MatchError(ContainSubstring("etcdEncryption is currently not supported for the provider")))
}
...
func TestClusterUpdateEtcdEncryption(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.testName, func(t *testing.T) {
			...
			g := NewWithT(t)
			_, err := newCluster.ValidateUpdate(baseCluster)
...
func TestClusterUpdateWorkerNodeGroupTaintsInvalid(t *testing.T) {
	...
	g := NewWithT(t)
	_, err := c.ValidateUpdate(cOld)
	g.Expect(err).To(MatchError(ContainSubstring("at least one WorkerNodeGroupConfiguration must not have NoExecute and/or NoSchedule taints")))
}
...
func TestClusterUpdateWorkerNodeGroupNameInvalid(t *testing.T) {
	...
	g := NewWithT(t)
	_, err := c.ValidateUpdate(cOld)
	g.Expect(err).To(MatchError(ContainSubstring("must specify name for worker nodes")))
}
...
func TestClusterUpdateWorkerNodeGroupLabelsInvalid(t *testing.T) {
	...
	g := NewWithT(t)
	_, err := c.ValidateUpdate(cOld)
	g.Expect(err).To(MatchError(ContainSubstring("labels for worker node group test not valid: found following errors with labels: spec.workerNodeGroupConfigurations[0].labels: Invalid value:")))
}
...
func TestClusterUpdateControlPlaneLabelsInvalid(t *testing.T) {
	...
	g := NewWithT(t)
	_, err := c.ValidateUpdate(cluster)
	g.Expect(err).To(MatchError(ContainSubstring("spec.controlPlaneConfiguration.labels: Invalid value")))
}
...
func TestClusterValidateCreateInvalidCluster(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			g := NewWithT(t)
			_, err := tt.cluster.ValidateCreate()
...
func TestClusterValidateUpdateInvalidManagementCluster(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			g := NewWithT(t)
			_, err := tt.clusterNew.ValidateUpdate(clusterOld)
...
func TestClusterValidateUpdateValidManagementCluster(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			g := NewWithT(t)
			_, err := newCluster.ValidateUpdate(tt.oldCluster)
			g.Expect(err).To(Succeed())
		})
	}
}
