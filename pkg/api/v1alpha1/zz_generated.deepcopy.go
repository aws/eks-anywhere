...
func (in *BottlerocketConfiguration) DeepCopyInto(out *BottlerocketConfiguration) {
	*out = *in
	...
	if in.Kernel != nil {
		...
		*out = new(v1beta1.BottlerocketKernelSettings)
		(*in).DeepCopyInto(*out)
	}
	if in.Boot != nil {
		in, out := &in.Boot, &out.Boot
		*out = new(v1beta1.BottlerocketBootSettings)
		(*in).DeepCopyInto(*out)
	}
}
...
func (in *ClusterCertificateInfo) DeepCopy() *ClusterCertificateInfo {
	...
	out := new(ClusterCertificateInfo)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ClusterStatus) DeepCopyInto(out *ClusterStatus) {
	*out = *in
	...
	if in.ClusterCertificateInfo != nil {
		in, out := &in.ClusterCertificateInfo, &out.ClusterCertificateInfo
...
func (in *ControlPlaneConfiguration) DeepCopyInto(out *ControlPlaneConfiguration) {
	*out = *in
	...
	if in.SkipAdmissionForSystemResources != nil {
		in, out := &in.SkipAdmissionForSystemResources, &out.SkipAdmissionForSystemResources
		*out = new(bool)
		**out = **in
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IPPoolConfiguration) DeepCopyInto(out *IPPoolConfiguration) {
	*out = *in
	if in.Addresses != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IPPoolConfiguration.
func (in *IPPoolConfiguration) DeepCopy() *IPPoolConfiguration {
	if in == nil {
		return nil
	}
	out := new(IPPoolConfiguration)
	in.DeepCopyInto(out)
	return out
}
...
func (in *NutanixDatacenterConfigSpec) DeepCopyInto(out *NutanixDatacenterConfigSpec) {
	*out = *in
	...
	if in.FailureDomains != nil {
		...
		*out = make([]NutanixDatacenterFailureDomain, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.CcmExcludeNodeIPs != nil {
		in, out := &in.CcmExcludeNodeIPs, &out.CcmExcludeNodeIPs
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
...
func (in *NutanixDatacenterFailureDomain) DeepCopyInto(out *NutanixDatacenterFailureDomain) {
	*out = *in
	...
	if in.WorkerMachineGroups != nil {
		in, out := &in.WorkerMachineGroups, &out.WorkerMachineGroups
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
...
func (in *NutanixDatacenterFailureDomain) DeepCopy() *NutanixDatacenterFailureDomain {
	...
	out := new(NutanixDatacenterFailureDomain)
	in.DeepCopyInto(out)
	return out
}
...
func (in *NutanixMachineConfigSpec) DeepCopyInto(out *NutanixMachineConfigSpec) {
	*out = *in
	...
	if in.GPUs != nil {
		...
		*out = make([]NutanixGPUIdentifier, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *SnowMachineConfigSpec) DeepCopyInto(out *SnowMachineConfigSpec) {
	*out = *in
	...
	if in.NonRootVolumes != nil {
		...
		*out = make([]*apiv1beta1.Volume, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(apiv1beta1.Volume)
