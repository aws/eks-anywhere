...
func (c *Cluster) RegistryMirrorOCINamespace() string {
	if c.Spec.RegistryMirrorConfiguration == nil {
		return ""
	}

	return c.Spec.RegistryMirrorConfiguration.OCINamespace
}

func (c *Cluster) RegistryMirrorPackageOCINamespace() string {
	if c.Spec.RegistryMirrorConfiguration == nil {
		return ""
	}

	return c.Spec.RegistryMirrorConfiguration.PackageOCINamespace
}
