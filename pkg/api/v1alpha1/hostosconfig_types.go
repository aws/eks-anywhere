...
import "sigs.k8s.io/cluster-api/api/bootstrap/kubeadm/v1beta2"
...
type BottlerocketConfiguration struct {
	...
	// +optional
	Kubernetes *v1beta2.BottlerocketKubernetesSettings `json:"kubernetes,omitempty"`

	// Kernel defines the kernel settings for bottlerocket.
	Kernel *v1beta2.BottlerocketKernelSettings `json:"kernel,omitempty"`
