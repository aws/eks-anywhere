...
//+kubebuilder:webhook:path=/mutate-anywhere-eks-amazonaws-com-v1alpha1-cloudstackmachineconfig,mutating=true,failurePolicy=fail,sideEffects=None,groups=anywhere.eks.amazonaws.com,resources=cloudstackmachineconfigs,verbs=create;update,versions=v1alpha1,name=mutation.cloudstackmachineconfig.anywhere.amazonaws.com,admissionReviewVersions={v1,v1beta1}

var _ webhook.Defaulter = &CloudStackMachineConfig{}

// Default implements webhook.Defaulter so a webhook will be registered for the type.
func (r *CloudStackMachineConfig) Default() {
	cloudstackmachineconfiglog.Info("Setting up CloudStack Machine Config defaults for", "name", r.Name)
	r.SetDefaults()
}
