...
//
//	mockgen --build_flags=--mod=mod -destination=pkg/providers/docker/reconciler/mocks/reconciler.go -package=mocks -source pkg/providers/docker/reconciler/reconciler.go
//
