...
type Provider interface {
	...
	UpgradeNeeded(ctx context.Context, newSpec, currentSpec *cluster.Spec, cluster *types.Cluster, datacenterConfig DatacenterConfig, machineConfigs []MachineConfig) (bool, error)
