...
//
//	mockgen --build_flags=--mod=mod -destination=pkg/providers/snow/mocks/clientregistry.go -package=mocks -source pkg/providers/snow/clientregistry.go
//
...
func (mr *MockClientRegistryMockRecorder) Get(ctx any) *gomock.Call {
