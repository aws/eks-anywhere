...
//
//	mockgen --build_flags=--mod=mod -destination=pkg/providers/snow/mocks/defaults.go -package=mocks -source pkg/providers/snow/defaults.go
//
...
func (mr *MockSshKeyGeneratorMockRecorder) GenerateSSHAuthKey(arg0 any) *gomock.Call {
