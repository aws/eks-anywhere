...
//
//	mockgen --build_flags=--mod=mod -destination=pkg/providers/snow/mocks/client.go -package=mocks -source pkg/providers/snow/snow.go
//
...
func (mr *MockKubeUnAuthClientMockRecorder) Apply(ctx, kubeconfig, obj any) *gomock.Call {
...
func (mr *MockKubeUnAuthClientMockRecorder) KubeconfigClient(kubeconfig any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
