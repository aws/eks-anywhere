...
//
//	mockgen --build_flags=--mod=mod -destination=pkg/providers/snow/mocks/aws.go -package=mocks -source pkg/providers/snow/aws.go
//
...
func (mr *MockAwsClientMockRecorder) EC2ImageExists(ctx, imageID any) *gomock.Call {
...
func (mr *MockAwsClientMockRecorder) EC2ImportKeyPair(ctx, keyName, keyMaterial any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAwsClientMockRecorder) EC2InstanceTypes(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAwsClientMockRecorder) EC2KeyNameExists(ctx, keyName any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAwsClientMockRecorder) IsSnowballDeviceUnlocked(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAwsClientMockRecorder) SnowballDeviceSoftwareVersion(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockLocalIMDSClientMockRecorder) EC2InstanceIP(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
