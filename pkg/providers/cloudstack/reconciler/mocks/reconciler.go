...
// Source: pkg/providers/cloudstack/reconciler/reconciler.go
//
// Generated by this command:
//
//	mockgen --build_flags=--mod=mod -destination=pkg/providers/cloudstack/reconciler/mocks/reconciler.go -package=mocks -source pkg/providers/cloudstack/reconciler/reconciler.go
//
...
func (mr *MockIPValidatorMockRecorder) ValidateControlPlaneIP(ctx, log, spec any) *gomock.Call {
...
func (m *MockCNIReconciler) Reconcile(ctx context.Context, logger logr.Logger, arg2 client.Client, spec *cluster.Spec) (controller.Result, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Reconcile", ctx, logger, arg2, spec)
	ret0, _ := ret[0].(controller.Result)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockCNIReconcilerMockRecorder) Reconcile(ctx, logger, arg2, spec any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Reconcile", reflect.TypeOf((*MockCNIReconciler)(nil).Reconcile), ctx, logger, arg2, spec)
}
...
func (m *MockRemoteClientRegistry) GetClient(ctx context.Context, arg1 client.ObjectKey) (client.Client, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetClient", ctx, arg1)
...
func (mr *MockRemoteClientRegistryMockRecorder) GetClient(ctx, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetClient", reflect.TypeOf((*MockRemoteClientRegistry)(nil).GetClient), ctx, arg1)
}
