...
func TestProviderGenerateCAPISpecForCreateWithMultiAvailabilityZones(t *testing.T) {
	...
	test.AssertContentToFile(t, string(cp), "testdata/expected_results_availability_zones_cp.yaml")
	test.AssertContentToFile(t, string(md), "testdata/expected_results_availability_zones_md.yaml")
}
