...
func (p *vsphereProvider) MachineConfigs() []providers.MachineConfig {
	...
	if p.clusterConfig.Annotations != nil && p.clusterConfig.Annotations[v1alpha1.ManagementAnnotation] != "" {
		p.machineConfigs[controlPlaneMachineName].SetManagement(p.clusterConfig.Annotations[v1alpha1.ManagementAnnotation])
	}
	...
	if workerMachineName != controlPlaneMachineName {
		...
		if p.clusterConfig.Annotations != nil && p.clusterConfig.Annotations[v1alpha1.ManagementAnnotation] != "" {
			p.machineConfigs[workerMachineName].SetManagement(p.clusterConfig.Annotations[v1alpha1.ManagementAnnotation])
		}
	}
	if p.clusterConfig.Spec.ExternalEtcdConfiguration != nil {
