...
//
//	mockgen --build_flags=--mod=mod -destination=pkg/providers/vsphere/internal/templates/mocks/govc.go -package=mocks -source pkg/providers/vsphere/internal/templates/factory.go GovcClient
//
...
func (mr *MockGovcClientMockRecorder) AddTag(ctx, path, tag any) *gomock.Call {
...
func (mr *MockGovcClientMockRecorder) CreateCategoryForVM(ctx, name any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockGovcClientMockRecorder) CreateLibrary(ctx, datastore, library any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockGovcClientMockRecorder) CreateTag(ctx, tag, category any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockGovcClientMockRecorder) DeleteLibraryElement(ctx, element any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockGovcClientMockRecorder) DeployTemplateFromLibrary(ctx, templateDir, templateName, library, datacenter, datastore, network, resourcePool, resizeBRDisk any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockGovcClientMockRecorder) GetLibraryElementContentVersion(ctx, element any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockGovcClientMockRecorder) ImportTemplate(ctx, library, ovaURL, name any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockGovcClientMockRecorder) LibraryElementExists(ctx, library any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockGovcClientMockRecorder) ListCategories(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockGovcClientMockRecorder) ListTags(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockGovcClientMockRecorder) SearchTemplate(ctx, datacenter, template any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
