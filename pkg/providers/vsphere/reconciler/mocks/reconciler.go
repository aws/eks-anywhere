...
//
//	mockgen --build_flags=--mod=mod -destination=pkg/providers/vsphere/reconciler/mocks/reconciler.go -package=mocks -source pkg/providers/vsphere/reconciler/reconciler.go
//
