...
//
//	mockgen --build_flags=--mod=mod -destination=pkg/providers/tinkerbell/reconciler/mocks/reconciler.go -package=mocks -source pkg/providers/tinkerbell/reconciler/reconciler.go
//
