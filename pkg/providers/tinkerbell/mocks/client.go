...
// Source: github.com/aws/eks-anywhere/pkg/providers/tinkerbell (interfaces: Docker,Helm,ProviderKubectlClient,SSHAuthKeyGenerator)
...
func (m *MockHelm) InstallChartWithValuesFile(arg0 context.Context, arg1, arg2, arg3, arg4, arg5 string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "InstallChartWithValuesFile", arg0, arg1, arg2, arg3, arg4, arg5)
	ret0, _ := ret[0].(error)
	return ret0
}

// InstallChartWithValuesFile indicates an expected call of InstallChartWithValuesFile.
func (mr *MockHelmMockRecorder) InstallChartWithValuesFile(arg0, arg1, arg2, arg3, arg4, arg5 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "InstallChartWithValuesFile", reflect.TypeOf((*MockHelm)(nil).InstallChartWithValuesFile), arg0, arg1, arg2, arg3, arg4, arg5)
}
