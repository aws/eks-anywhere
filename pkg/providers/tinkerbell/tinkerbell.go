...
func (p *tinkerbellProvider) SetupAndValidateCreateCluster(ctx context.Context, clusterSpec *cluster.Spec) error {
	...
	if err := p.validator.ValidateHardwareConfig(ctx, p.hardwareConfigFile, p.skipBmcCheck); err != nil {
		return err
	}
