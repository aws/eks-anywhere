...
//
//	mockgen --build_flags=--mod=mod -destination=pkg/providers/tinkerbell/stack/mocks/stack.go -package=mocks -source pkg/providers/tinkerbell/stack/stack.go Docker,Helm,StackInstaller
//
...
func (mr *MockDockerMockRecorder) CheckContainerExistence(ctx, name any) *gomock.Call {
...
func (mr *MockDockerMockRecorder) ForceRemove(ctx, name any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockDocker) Run(ctx context.Context, image, name string, cmd []string, flags ...string) error {
	m.ctrl.T.Helper()
	varargs := []any{ctx, image, name, cmd}
	for _, a := range flags {
...
func (mr *MockDockerMockRecorder) Run(ctx, image, name, cmd any, flags ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, image, name, cmd}, flags...)
...
func (mr *MockHelmMockRecorder) ListCharts(ctx, kubeconfigFilePath, filter, namespace any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockHelmMockRecorder) RegistryLogin(ctx, endpoint, username, password any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockHelm) Uninstall(ctx context.Context, chart, kubeconfigFilePath, namespace string, opts ...helm.Opt) error {
	m.ctrl.T.Helper()
	varargs := []any{ctx, chart, kubeconfigFilePath, namespace}
	for _, a := range opts {
		varargs = append(varargs, a)
	}
...
func (mr *MockHelmMockRecorder) Uninstall(ctx, chart, kubeconfigFilePath, namespace any, opts ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, chart, kubeconfigFilePath, namespace}, opts...)
...
func (m *MockHelm) UpgradeInstallChartWithValuesFile(ctx context.Context, chart, ociURI, version, kubeconfigFilePath, namespace, valuesFilePath string, opts ...helm.Opt) error {
	m.ctrl.T.Helper()
	varargs := []any{ctx, chart, ociURI, version, kubeconfigFilePath, namespace, valuesFilePath}
	for _, a := range opts {
		varargs = append(varargs, a)
	}
...
func (mr *MockHelmMockRecorder) UpgradeInstallChartWithValuesFile(ctx, chart, ociURI, version, kubeconfigFilePath, namespace, valuesFilePath any, opts ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, chart, ociURI, version, kubeconfigFilePath, namespace, valuesFilePath}, opts...)
...
func (mr *MockStackInstallerMockRecorder) AddNoProxyIP(IP any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStackInstallerMockRecorder) CleanupLocalBoots(ctx, forceCleanup any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStackInstallerMockRecorder) HasChart(ctx, chartName, kubeconfig, namespace any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockStackInstaller) Install(ctx context.Context, bundle v1alpha1.TinkerbellBundle, tinkerbellIP, kubeconfig, hookOverride string, opts ...stack.InstallOption) error {
	m.ctrl.T.Helper()
	varargs := []any{ctx, bundle, tinkerbellIP, kubeconfig, hookOverride}
	for _, a := range opts {
		varargs = append(varargs, a)
	}
...
func (mr *MockStackInstallerMockRecorder) Install(ctx, bundle, tinkerbellIP, kubeconfig, hookOverride any, opts ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, bundle, tinkerbellIP, kubeconfig, hookOverride}, opts...)
...
func (mr *MockStackInstallerMockRecorder) UninstallChart(ctx, chartName, kubeconfig, namespace any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStackInstallerMockRecorder) UninstallLocal(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockStackInstaller) Upgrade(arg0 context.Context, arg1 v1alpha1.TinkerbellBundle, tinkerbellIP, kubeconfig, hookOverride string, opts ...stack.InstallOption) error {
	m.ctrl.T.Helper()
	varargs := []any{arg0, arg1, tinkerbellIP, kubeconfig, hookOverride}
	for _, a := range opts {
		varargs = append(varargs, a)
	}
...
func (mr *MockStackInstallerMockRecorder) Upgrade(arg0, arg1, tinkerbellIP, kubeconfig, hookOverride any, opts ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{arg0, arg1, tinkerbellIP, kubeconfig, hookOverride}, opts...)
...
func (m *MockStackInstaller) UpgradeInstallCRDs(ctx context.Context, bundle v1alpha1.TinkerbellBundle, kubeconfig string, opts ...stack.InstallOption) error {
	m.ctrl.T.Helper()
	varargs := []any{ctx, bundle, kubeconfig}
	for _, a := range opts {
		varargs = append(varargs, a)
	}
...
func (mr *MockStackInstallerMockRecorder) UpgradeInstallCRDs(ctx, bundle, kubeconfig any, opts ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, bundle, kubeconfig}, opts...)
...
func (mr *MockStackInstallerMockRecorder) UpgradeLegacy(ctx, bundle, kubeconfig any, opts ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, bundle, kubeconfig}, opts...)
