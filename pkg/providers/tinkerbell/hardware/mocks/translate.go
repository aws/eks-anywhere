...
//
//	mockgen --build_flags=--mod=mod -destination=pkg/providers/tinkerbell/hardware/mocks/translate.go -package=mocks -source pkg/providers/tinkerbell/hardware/translate.go MachineReader,MachineWriter,MachineValidator
//
...
func (mr *MockMachineWriterMockRecorder) Write(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockMachineValidatorMockRecorder) Validate(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
