...
type ImageTaggerPusher interface {
	PushImage(ctx context.Context, image string, endpoint string, ociNamespace string) error
	TagImage(ctx context.Context, image string, endpoint string, ociNamespace string) error
}
