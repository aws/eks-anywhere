...
func (t *Tinkerbell) WithTinkerbellTemplateConfig(name string, templateConfig *anywherev1.TinkerbellTemplateConfig) api.ClusterConfigFiller {
	return api.TinkerbellToConfigFiller(api.WithTinkerbellTemplateConfig(name, templateConfig))
}
