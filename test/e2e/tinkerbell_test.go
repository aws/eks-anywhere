...
// TestTinkerbellKubernetes136Ubuntu2404MultiNICBootstrapIPSimpleFlow validates cluster
...
func TestTinkerbellKubernetes136Ubuntu2404MultiNICBootstrapIPSimpleFlow(t *testing.T) {
	licenseToken := framework.GetLicenseToken()
	provider := framework.NewTinkerbell(t)
