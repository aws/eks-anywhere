...
func TestTinkerbellKubernetes120UbuntuWorkerNodeUpgrade(t *testing.T) {
	provider := framework.NewTinkerbell(t, framework.WithUbuntu120Tinkerbell())
	test := framework.NewClusterE2ETest(
		t,
		provider,
		framework.WithClusterFiller(api.WithKubernetesVersion(v1alpha1.Kube120)),
...
func TestTinkerbellKubernetes120UbuntuControlPlaneUpgrade(t *testing.T) {
	provider := framework.NewTinkerbell(t, framework.WithUbuntu120Tinkerbell())
	test := framework.NewClusterE2ETest(
		t,
		provider,
...
func TestTinkerbellKubernetes120UbuntuWorkerNodeScaleDown(t *testing.T) {
	provider := framework.NewTinkerbell(t, framework.WithUbuntu120Tinkerbell())
	test := framework.NewClusterE2ETest(
		t,
		provider,
...
func TestTinkerbellKubernetes120UbuntuControlPlaneScaleDown(t *testing.T) {
	provider := framework.NewTinkerbell(t, framework.WithUbuntu120Tinkerbell())
	test := framework.NewClusterE2ETest(
		t,
		provider,
...
func TestTinkerbellKubernetes120UbuntuTo121Upgrade(t *testing.T) {
	provider := framework.NewTinkerbell(t, framework.WithUbuntu120Tinkerbell())
	test := framework.NewClusterE2ETest(
		t,
		provider,
	...
	runSimpleUpgradeFlow(
		...
		v1alpha1.Kube121,
		framework.WithClusterUpgrade(api.WithKubernetesVersion(v1alpha1.Kube121)),
		provider.WithProviderUpgrade(framework.UpdateTinkerbellUbuntuTemplate121Var()),
	)
}
