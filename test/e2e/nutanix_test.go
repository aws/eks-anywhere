...
func TestNutanixKubernetes133UbuntuWorkerNodeScaleUp1To3(t *testing.T) {
...
func TestNutanixKubernetes133OIDC(t *testing.T) {
	test := framework.NewClusterE2ETest(
		t,
		framework.NewNutanix(t, framework.WithUbuntu133Nutanix()),
		framework.WithOIDC(),
...
func TestNutanixKubernetes133AWSIamAuth(t *testing.T) {
	test := framework.NewClusterE2ETest(
		t,
		framework.NewNutanix(t, framework.WithUbuntu133Nutanix()),
		framework.WithAWSIam(),
...
func TestNutanixKubernetes133UbuntuManagementCPUpgradeAPI(t *testing.T) {
	licenseToken := framework.GetLicenseToken()
	provider := framework.NewNutanix(t, framework.WithUbuntu133Nutanix())
	test := framework.NewClusterE2ETest(
		t, provider,
...
func TestNutanixKubernetes133KubeletConfigurationSimpleFlow(t *testing.T) {
	test := framework.NewClusterE2ETest(
		t,
		framework.NewNutanix(t, framework.WithUbuntu133Nutanix()),
		framework.WithClusterFiller(api.WithKubernetesVersion(v1alpha1.Kube133)),
...
func TestNutanixKubernetes133UbuntuControlPlaneNodeScaleUp1To3(t *testing.T) {
	provider := framework.NewNutanix(t, framework.WithUbuntu133Nutanix())
	test := framework.NewClusterE2ETest(
		t,
		provider,
...
func TestNutanixKubernetes133UbuntuWorkerNodeScaleDown3To1(t *testing.T) {
	provider := framework.NewNutanix(t, framework.WithUbuntu133Nutanix())
	test := framework.NewClusterE2ETest(
		t,
		provider,
...
func TestNutanixKubernetes133UbuntuControlPlaneNodeScaleDown3To1(t *testing.T) {
	provider := framework.NewNutanix(t, framework.WithUbuntu133Nutanix())
	test := framework.NewClusterE2ETest(
		t,
		provider,
