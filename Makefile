...
mocks: ## Generate mocks
	...
	${GOPATH}/bin/mockgen -destination=pkg/curatedpackages/mocks/registryclient.go -package=mocks github.com/aws/eks-anywhere-packages/pkg/bundle RegistryClient
