...
mocks: ## Generate mocks
	...
	${GOPATH}/bin/mockgen -destination=pkg/providers/snow/mocks/validator.go -package=mocks -source "pkg/providers/snow/validator.go"
	${GOPATH}/bin/mockgen -destination=pkg/providers/snow/reconciler/mocks/validatorbuilder.go -package=mocks -source "pkg/providers/snow/reconciler/validatorbuilder.go"
