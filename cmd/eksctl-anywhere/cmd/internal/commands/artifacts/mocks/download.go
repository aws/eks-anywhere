...
//
//	mockgen --build_flags=--mod=mod -destination=cmd/eksctl-anywhere/cmd/internal/commands/artifacts/mocks/download.go -package=mocks -source cmd/eksctl-anywhere/cmd/internal/commands/artifacts/download.go
//
...
func (mr *MockReaderMockRecorder) ReadBundlesForVersion(eksaVersion any) *gomock.Call {
...
func (mr *MockReaderMockRecorder) ReadChartsFromBundles(ctx, bundles any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockReaderMockRecorder) ReadImagesFromBundles(ctx, bundles any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockImageMoverMockRecorder) Move(ctx any, artifacts ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx}, artifacts...)
...
func (mr *MockChartDownloaderMockRecorder) Download(ctx any, artifacts ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx}, artifacts...)
...
// Download indicates an expected call of Download.
func (mr *MockManifestDownloaderMockRecorder) Download(ctx, bundles any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPackagerMockRecorder) Package(folder, dstFile any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
