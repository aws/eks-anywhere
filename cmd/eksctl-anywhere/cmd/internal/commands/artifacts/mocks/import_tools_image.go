...
//
//	mockgen --build_flags=--mod=mod -destination=cmd/eksctl-anywhere/cmd/internal/commands/artifacts/mocks/import_tools_image.go -package=mocks -source cmd/eksctl-anywhere/cmd/internal/commands/artifacts/import_tools_image.go
//
...
func (mr *MockUnPackagerMockRecorder) UnPackage(orgFile, dstFolder any) *gomock.Call {
