...
// Source: cmd/eksctl-anywhere/cmd/internal/commands/artifacts/download_artifacts.go
...
func (m *MockReader) ReadBundlesForVersion(version string) (*v1alpha1.Bundles, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ReadBundlesForVersion", version)
...
func (mr *MockReaderMockRecorder) ReadBundlesForVersion(version interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ReadBundlesForVersion", reflect.TypeOf((*MockReader)(nil).ReadBundlesForVersion), version)
}

// ReadCharts mocks base method.
func (m *MockReader) ReadCharts(eksaVersion string) ([]v1alpha1.Image, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ReadCharts", eksaVersion)
	ret0, _ := ret[0].([]v1alpha1.Image)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ReadCharts indicates an expected call of ReadCharts.
func (mr *MockReaderMockRecorder) ReadCharts(eksaVersion interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ReadCharts", reflect.TypeOf((*MockReader)(nil).ReadCharts), eksaVersion)
}
