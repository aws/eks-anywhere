...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-snowball-device.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-snowball-device.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-snowball-device.dev",
			expectURL:     aws.String("https://env-snowball-device.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-snowball-device.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-snowball-device.dev",
			expectURL:     aws.String("http://config-snowball-device.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-snowball-device.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-snowball-device.dev",
			clientEndpoint: aws.String("https://client-snowball-device.dev"),
			expectURL:      aws.String("https://client-snowball-device.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_SNOWBALL_DEVICE", c.envService)
			}
