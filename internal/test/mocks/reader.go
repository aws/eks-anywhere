...
//
//	mockgen --build_flags=--mod=mod -destination=internal/test/mocks/reader.go -package=mocks -source internal/test/reader.go
//
...
func (mr *MockReaderMockRecorder) ReadFile(url any) *gomock.Call {
