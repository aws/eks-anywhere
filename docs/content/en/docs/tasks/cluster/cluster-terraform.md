...
>**_NOTE_**: Support for using Terraform to manage and modify an EKS Anywhere cluster is available for vSphere and Snow clusters, but not yet for Bare Metal, CloudStack, or Nutanix clusters.
>
