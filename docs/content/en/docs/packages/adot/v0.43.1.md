...
We included sample configurations below for reference. For in-depth examples and use cases, please refer to [ADOT with AMP and AMG.]({{< relref "adot_amp_amg.md" >}})

**Recommended: Using Presets (Simplified Configuration)**

This approach uses presets to automatically configure RBAC permissions:
...
**Advanced: Explicit RBAC Rules**

For custom configurations requiring specific permissions:
