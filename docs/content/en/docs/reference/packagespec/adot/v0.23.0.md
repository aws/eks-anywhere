...
We included a sample configuration below for reference. For in-depth examples and and use cases, please refer to [ADOT workshop.]({{< relref "../../../workshops/packages/adot" >}})
