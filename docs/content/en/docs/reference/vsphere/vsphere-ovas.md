...
weight: 30
description: >
  Importing EKS-A OVAs to vSphere
---

If you want to specify an OVF template, you will need to import OVA files into vSphere before you can use it in your EKS-A cluster.
