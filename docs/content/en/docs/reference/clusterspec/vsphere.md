...
### name (required)
Name of your cluster, which is `my-cluster-name` in this example.
...
There are several ways to obtain your vCenter thumbprint. If you have `govc` installed, the easiest way is to
run:
