...
Operators can also leverage the [CNI chaining](https://docs.cilium.io/en/v1.13/installation/cni-chaining/) feature from Isovalent where in both Cilium as the CNI and another CNI can work in a chain mode.
{{% /alert %}}
