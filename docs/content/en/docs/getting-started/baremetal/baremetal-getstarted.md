...
1. Configure Curated Packages
   ...
   If you are going to use packages, set up authentication. These credentials should have [limited capabilities]({{< relref "./bare-prereq#setup-authentication-to-use-curated-packages" >}}):
   ```bash
